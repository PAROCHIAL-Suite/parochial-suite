...
<body>
	...
	<div class="pageName card-heading">
		<table border="0">
			<tr>
				<td width="40%" ><h3>EDIT HOLY COMMUNION RECORD</h3></td>
			</tr>
		</table>
	...
	<form id="baptism_form" method="post" action="edit_script.php?id=<?php echo $rows['id']; ?>">
		<table width="100%"  border="0" cellspacing="10" class="form">
			...
			<tr>
				...
				<td><input type="text" name="baptism_date" class="auto-format-date" value="<?php echo $rows['baptism_date']; ?>" placeholder="dd/mm/yyyy"></td>
			</tr>			
			<tr>
			...
			<tr>				
				<td><p>CHURCH OF HOLY COMMUNION</p></td>
				<td><input type="text" name="church_of_eucharist" value="<?php echo $rows['church_of_comunion']; ?>"></td>				
			</tr>		
			<tr>				
				<td><p>DATE OF HOLY COMMUNION</p></td>
				<td><input type="text" name="date" class="auto-format-date" value="<?php echo $rows['date_of_communion']; ?>" placeholder="dd/mm/yyyy"></td>			
			</tr>							
			<tr></tr><tr></tr><tr></tr>
			<tr>
