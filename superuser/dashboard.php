                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            while ($rows = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    <td>
                                        <a href="../superuser-family/family.php?id=<?php echo $rows['church_code']; ?>"
                                            class="table-action"><span
                                                title="View more record of this parish">View</span></a>
                                    </td>
                                    ...
                                    <td><span
                                            class="status-badge fulfilled"><?php echo $rows['total_family_members']; ?></span>
                                    </td>
