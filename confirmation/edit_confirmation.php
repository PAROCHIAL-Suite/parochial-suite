		...
		<form id="baptism_form" method="post" action="edit_script.php?id=<?php echo $id; ?>">
			<table width="100%" border="0" cellspacing="10" class="form">
				...
				<tr>
					...
					<td><input type="text" name="dob" class="auto-format-date" value="<?php echo $rows['dob']; ?>"
				...
				<tr>
					...
					<td><input type="text" class="auto-format-date" name="baptism_date"
							value="<?php echo $rows['baptism_date']; ?>"></td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<p>DATE OF CONFIRMATION</p>
					</td>
					<td><input type="text" class="auto-format-date" name="date"
							value="<?php echo $rows['date_of_confirmation']; ?>"></td>
				</tr>
				<tr></tr>
				<tr></tr>
				<tr></tr>
