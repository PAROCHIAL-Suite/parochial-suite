...
<body>
  ...
  <br><br>
    ...
    <table border="0">
      <tr>
        <td width="40%"><h3>CERTIFICATE PRINTING</h3></td>
      </tr>
    </table>
  </div>
  ...
  <br>
    ...
    <div class="reportContainer">
      <div id="printJS-form">
          ...
          <br>
      	<div style="text-align: center; font-size: 29px; font-style: italic; font-weight: bold;">Certificate of Baptism</div>
          <br>
          <?php
        ...
        <table class="certificateData " width="100%" border="0" cellpadding="4" cellspacing="5" style="margin-left: 30px;">
            <tr>
                <td width="5%">1.</td>
            ...
            <tr>
                ...
                <td >Remarks</td>       
                <td>:</td>     
                <td style="font-size: 14px; font-style: italic"><?php echo $rows['remarks']; }?></td>
            </tr>                         
          </table>
