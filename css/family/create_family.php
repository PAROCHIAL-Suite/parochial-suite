...
<body style="overflow: auto;">
	...
	<form id="" class="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		<table width="100%"  border="0" cellspacing="10" class="form">
			...
			<tr>
				<td width=""><p>HEAD OF THE FAMILY</p></td>
				<td width="20px"><input placeholder="Name" type="text" id="head_name" name="name" required>			
				</td>
			<td width="200px">	
			...
			<tr>
				<td><p>ADDRESS</p></td>
				<td colspan="4"><input type="text" name="address" id="address" style="width: 99%;"></td>						
			</tr>
			<tr>
				<td></td>
