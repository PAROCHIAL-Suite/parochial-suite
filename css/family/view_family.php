...
<body>
	...
	<div  id="printJS-form">
		<div style="border-bottom:  double ;text-align: center; font-family: 'Calibri', sans-serif;">
	...
	<br>
		...
		<tr style="height: 40px;">	
			...
			<td style="text-align: center;" width="20%"><?php echo  $rows['name'] . " " . $rows['surname']; ?></td>				
			<td style="text-align: center;" width="12%"><?php echo  $rows['dob']; ?></td>
			<td style="text-align: center;" width="12%"><?php echo  $rows['gender']; ?></td>
			<td style="text-align: center;" width="12%"><?php echo  $rows['contact_no']; ?></td>
			<td style="text-align: center;" width="12%"><?php echo  $rows['relation_with_head']; ?></td>
