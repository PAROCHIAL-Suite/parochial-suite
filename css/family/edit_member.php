	...
	<div class="form" style="width: 84%; margin:  auto;">
		<table width="100%"  border="0" cellspacing="7" class="" style="font-family: 'Source Sans 3',sans-serif; margin: auto;">
			...
			<tr>
				...
				<td width="19%"><P>STATUS REMARK</p></td>
			...
			<tr>
				<td></td>
				<td><input type="submit" name="update_family_member" id="saveFrm" value="Save Changes" style="width: 120px;"></td>
				<td></td>
			</tr>
		</table>		
	</form>  
