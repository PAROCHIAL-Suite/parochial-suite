...
<body>
	...
	<div class="pageName card-heading">
		<table border="0">
			<tr>
				<td width="40%"><h3>EDIT MEMBER</h3></td>
			</tr>
		</table>
	</div>

	<form id="" class="" method="post" action="update_member.php?member_code=<?php echo $member_ID; ?>">
    
	<div class="form">
	<table width="100%"  border="0" cellspacing="7" class="" style="font-family: 'Source Sans 3',sans-serif; margin: auto;">
			<tr>
				<td colspan="4" ><h4>Baisc Details</h4></td>
			</tr><tr></tr><tr></tr>
			<tr>
				<td><p>MEMBER ID</p></td>
				<td><input type="text" name="member_ID" value="<?php echo $member_ID; ?>" readonly>  </td>
				<td><p>FAMILY ID</p></td>
			...
			<tr>
				...
				<td><P>Status remark</p></td>
				<td><input type="text" name="status_remark" value="<?php echo $status_remark ?>"></td></td>
			</tr>			
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td><p>NAME</p></td>
				<td><input onblur="getLastName()"  type="text" name="name" value="<?php echo $name; ?>" required></td>							
				<td><p>SURNAME</p></td>
			...
			<tr>
				<td></td>
				<td>  <button>Cancel</button> <input type="submit" name="update_family_member" id="saveFrm" value="Save"></td>
				<td></td>
			</tr>
		</table>		
	</form>  
