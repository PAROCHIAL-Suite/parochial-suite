	...
	<form id="" class="" method="post" action="update_priest.php?id=<?php echo $priest_id;?>">
		<table width="20%"  border="0" cellspacing="14" class="form" style="margin-left: ;">
			...
			<tr>
				...
				<td width="200px"><input type="text" name="name" value="<?php echo $name; ?>">  </td>
			...
			<tr>
				...
				<td><input type="date" name="start_date" value="<?php echo reverseFormat($start_date); ?>">  </td>
				<td><p>END DATE</p></td>
				<td><input type="date" name="end_date" value="<?php echo reverseFormat($end_date); ?>">  </td>										
			</tr>
			<tr></tr><tr></tr>
			<tr>
				<td></td>
